window.RELAYR = (function (win, doc) {
    ...
    function Relayr(credentials){
      ...
      function devices() {
        ...
        this.getDevice = function(deviceId, successCb, errorCb) {
            if(!deviceId) {
                throw new Error("Provide a device id");
            }
            ...
            util.ajax({
              url: self.config.url + "devices/" + deviceId ,
              type: "GET",
        ...
        this.getDeviceState = function(deviceId, successCb, errorCb) {
            if(!deviceId) {
                throw new Error("Provide a device id");
            }
            ...
            util.ajax({
              url: self.config.url + "devices/" + deviceId + '/state',
              type: "GET",
              token: "Bearer "+ self.account.token,
              isObject: true
            }, function(device){
