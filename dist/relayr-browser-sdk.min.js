...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.__RewireAPI__ = exports.__ResetDependency__ = exports.__set__ = exports.__Rewire__ = exports.__GetDependency__ = exports.__get__ = exports.transmitter = exports.model = exports.group = exports.device = undefined;
	...
	var group = exports.group = _get__('Group');

	var model = exports.model = _get__('Model');

	var transmitter = exports.transmitter = _get__('Transmitter');
	...
	var Ajax = function () {
	    ...
	    _createClass(Ajax, [{
	        ...
	        value: function get(url) {
	            ...
	            var opts = arguments.length <= 1 || arguments[1] === undefined ? { contentType: 'application/json' } : arguments[1];
	        ...
	        value: function post(url, body) {
	            ...
	            var opts = arguments.length <= 2 || arguments[2] === undefined ? { contentType: 'application/json' } : arguments[2];
	...
	var Transmitter = function () {
	  ...
	  _createClass(Transmitter, [{
	    ...
	    value: function deleteTransmitter(opts) {
	      ...
	      return new Promise(function (resolve, reject) {
	        _this.ajax.delete('/transmitters/' + _this.transmitterId, opts).then(function (response) {
	          //right now the object hangs around, but on the cloud it is gone
	          resolve(response);
	        }).catch(function (error) {
	          reject(error);
	    ...
	    value: function updateTransmitter(patch, opts) {
	      var _this2 = this;
	      ...
	      return new Promise(function (resolve, reject) {
	        _this2.ajax.patch('/transmitters/this.transmitterId}', patch, opts).then(function (response) {
	          _this2.transmitterId = response.transmitterId, _this2.secret = response.secret, _this2.name = response.name, _this2.topic = response.topic, _this2.owner = response.owner, _this2.integrationType = response.integrationType, resolve(response);
	        }).catch(function (error) {
	          reject(error);
	        });
	      });
