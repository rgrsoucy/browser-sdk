(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        global.mqttws31Min = mod.exports;
    }
    ...
    var Paho = function Paho() {
        _classCallCheck(this, Paho);

        //var window = {};
        var _Paho = {};
        _Paho.MQTT = function (global) {
            ...
            function decodeMessage(input, pos) {
                ...
                switch (type) {
                    ...
                    case MESSAGE_TYPE.PUBLISH:
                        ...
                        var message = new _Paho.MQTT.Message(input.subarray(pos, endPos));
            ...
            ClientImpl.prototype.restore = function (key) {
                ...
                switch (storedMessage.type) {
                    case MESSAGE_TYPE.PUBLISH:
                        ...
                        var payloadMessage = new _Paho.MQTT.Message(byteStream);
